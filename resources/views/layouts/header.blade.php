                        ...
                        <div class="dropdown">
                            ...
                            <div class="basketContent dropdown-menu dropdown-menu-end p-3 slideDownIn" style="">
                                        ...
                                        <div class="header__top--basketItemsContent" >
                                            ...
                                            <div class="header__top--basketItemContent">
                                                <h6 class="header__top--basketItemTitle">
                                                    <a href="/apple-iphone-8-plus-64-gb-space-gray-352"></a>
                                                </h6>
                                ...
                                <div class="header__top--basketButtons">
                                    <a href="" class="btn btn-color-citronella header__top--buyNow" title="Hemen Al">Hemen Al</a>
                                    <a href=""  class="btn btn-color-light header__top--gotoCart" title="Sepete Git">Sepete Git</a>
                                </div>
                            </div>
                        </div>    
                    </div>
